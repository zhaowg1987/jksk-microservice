...
public class DateUtil {
    ...
    public static boolean validateIsDate(String strTime) {
        ...
        if (date != null) {
            log.info("生成的日期:"+DateUtil.parseDateToStr(date, DateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS, "--null--"));
            return true;
        }
        return false;
    }
    ...
    /**
     * 获取当前日期  YYYY_MM_DD_HH_MI_SS
     * @return YYYY_MM_DD_HH_MI_SS 格式日期
     */
    public static String getNowDateTime() {
        return parseDateToStr(new Date(),DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
    }
